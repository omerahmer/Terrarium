...
// Large enumerated option lists sourced from AWS (see aws-catalog-data.ts,
// generated by scripts/fetch-pricing.mjs from the AWS Price List).
export type AwsOptionsCatalog =
  | "ec2-instance-types"
...
export interface AwsPropertyDefinition {
  ...
  inputType: "text" | "select" | "multiselect" | "combobox" | "number";
  required?: boolean;
  placeholder?: string;
  defaultValue?: AwsPropertyValue;
  options?: AwsPropertyOption[];
  optionResourceTypes?: AwsResourceType[];
  // Resolve options from the AWS-sourced catalog (for combobox fields).
  optionsCatalog?: AwsOptionsCatalog;
  // For number inputs.
  min?: number;
  step?: number;
  unit?: string;
  ...
  },
  {
    ...
    properties: [
      ...defaultIdentityProperties,
      {
        ...
        optionsCatalog: "ec2-instance-types",
        helperText: "Current-generation types from the AWS Price List.",
      },
      {
        key: "operatingSystem",
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        min: 0,
        step: 100000,
        helperText: "Used for cost estimation.",
      },
      {
        key: "avgDurationMs",
        label: "Avg Duration",
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        min: 0,
        step: 100000,
        helperText: "On-demand read requests (for cost estimation).",
      },
      {
        key: "writesPerMonth",
        label: "Writes / month",
        ...
        min: 0,
        step: 100000,
        helperText: "On-demand write requests (for cost estimation).",
      },
      {
        key: "provisionedRcu",
        ...
        min: 0,
        step: 1,
        helperText: "Only used when Capacity Mode is Provisioned.",
      },
      {
        key: "provisionedWcu",
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        optionsCatalog: "rds-instance-classes",
        helperText: "Current-generation DB instance classes from AWS.",
      },
      {
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        optionsCatalog: "elasticache-node-types",
        helperText: "Current-generation cache nodes from AWS.",
      },
      {
        key: "numNodes",
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        min: 0,
        step: 10000,
        helperText: "GET/PUT requests per month, for cost estimation.",
      },
    ],
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        min: 0,
        step: 100,
        helperText: "Only billed for io2 volumes.",
      },
    ],
...
const optionsCatalogMap: Record<AwsOptionsCatalog, SizingOption[]> = {
  "ec2-instance-types": EC2_INSTANCE_TYPES,
  "rds-instance-classes": RDS_INSTANCE_CLASSES,
  "elasticache-node-types": ELASTICACHE_NODE_TYPES,
};

export function getCatalogOptions(
  catalog: AwsOptionsCatalog,
): AwsPropertyOption[] {
  return optionsCatalogMap[catalog] ?? [];
}
